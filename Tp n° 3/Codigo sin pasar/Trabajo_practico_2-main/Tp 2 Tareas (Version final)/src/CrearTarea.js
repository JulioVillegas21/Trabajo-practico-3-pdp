...
function CrearTarea(tareas) {
    ...
    */
    ...
    for (var i = 0; i < Tarea_1.estado.length; i++) {
        console.log("[".concat(i + 1, "] ").concat(Tarea_1.estado[i]));
    }
    ...
    for (var i = 0; i < Tarea_1.dificultad.length; i++) {
        console.log("[".concat(i + 1, "] ").concat(Tarea_1.dificultad[i]));
    }
